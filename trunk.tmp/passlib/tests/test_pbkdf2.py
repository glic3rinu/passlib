...
#test grub alg
#=========================================================
if enable_suite("grub", "extra"):
    class GrubSha512Test(CryptTestCase):
        "test UnixCrypt algorithm"
        alg = mod.GrubSha512
        positive_knowns = (
            #secret, example hash which matches secret
            ('hello', 'grub.pbkdf2.sha512.10000.9290F727ED06C38BA4549EF7DE25CF5642659211B7FC076F2D28FEFD71784BB8D8F6FB244A8CC5C06240631B97008565A120764C0EE9C2CB0073994D79080136.887CFF169EA8335235D8004242AA7D6187A41E3187DF0CE14E256D85ED97A97357AAA8FF0A3871AB9EEFF458392F462F495487387F685B7472FC6C29E293F0A0'),
            )
        invalid_identify = (
            #bad char in otherwise correctly formatted hash
            'grub.pbkdf2.sha512.10000.X290F727ED06C38BA4549EF7DE25CF5642659211B7FC076F2D28FEFD71784BB8D8F6FB244A8CC5C06240631B97008565A120764C0EE9C2CB0073994D79080136.887CFF169EA8335235D8004242AA7D6187A41E3187DF0CE14E256D85ED97A97357AAA8FF0A3871AB9EEFF458392F462F495487387F685B7472FC6C29E293F0A0',
            )
        negative_identify = (
