...
class mssql2000(uh.HasRawSalt, uh.HasRawChecksum, uh.GenericHandler):
    ...
    #=========================================================
    name = "mssql2000"
    description = "SHA1-based hash, used to store MS SQL Server 2000 user passwords"
    setting_kwds = ("salt",)
    checksum_size = 40
...
class mssql2005(uh.HasRawSalt, uh.HasRawChecksum, uh.GenericHandler):
    ...
    #=========================================================
    name = "mssql2005"
    description = "SHA1-based hash, used to store MS SQL Server 2005 user passwords"
    setting_kwds = ("salt",)
